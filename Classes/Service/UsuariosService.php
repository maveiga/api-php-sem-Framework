...
class UsuariosService
{
    ...
    public function validarDelete()
    {
        ...
        if (in_array($recurso, self::RECURSOS_DELETE, true)) {
            if ($this->dados['id'] > 0) {
                ...
                throw new InvalidArgumentExceptionAlias(ConstantesGenericasUtil::MSG_ERRO_ID_OBRIGATORIO);
            }
        } else {
            throw new InvalidArgumentExceptionAlias(ConstantesGenericasUtil::MSG_ERRO_RECURSO_INEXISTENTE);
        }
        ...
        if ($retorno === null) {
            throw new InvalidArgumentExceptionAlias(ConstantesGenericasUtil::MSG_ERRO_GENERICO);
        }
    ...
    private function cadastrar(){
        ...
        throw new InvalidArgumentExceptionAlias(ConstantesGenericasUtil::MSG_ERRO_LOGIN_SENHA_OBRIGATORIO);
    }
